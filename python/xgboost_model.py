...
class xgb_model_classifier(predictionTest):
    def __init__(self,
                 site_name,
                 model_name,
                 model_type,
    ...
    def runTest(self, site_data):
        try:
            ...
            self._predicted_values = self._model.predict(X_test)
            self._prediction_probabilities = self._model.predict_proba(X_test)
...
class xgb_model_regressor(predictionTest):
    def __init__(self,
                 site_name,
                 model_name,
                 model_type,
